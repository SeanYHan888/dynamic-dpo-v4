...
usage() {
  cat <<'EOF'
Usage: run_script/beta_dpo_offline/run_llama3_beta_dpo.sh <ultrafeedback|hh-helpful|hh-harmless> [extra run_beta_dpo args...]
...
case "$VARIANT" in
  ultrafeedback)
    CONFIG_PATH="training_configs/llama3-8b-base/beta-dpo/llama-3-8b-base-beta-dpo-ultrafeedback.yaml"
    RUN_PREFIX="llama-3-8b-base-beta-dpo-ultrafeedback-8xh200"
    DEFAULT_REPO_ID="W-61/llama-3-8b-base-beta-dpo-ultrafeedback-8xh200"
    VARIANT_MODEL_ENV="${ULTRAFEEDBACK_SFT_DIR:-}"
    DEFAULT_MODEL_GLOB="$SCRATCH_ROOT/outputs/llama-3-8b-base-sft-ultrachat-8xh200-*"
    ;;
  hh-helpful)
    CONFIG_PATH="training_configs/llama3-8b-base/beta-dpo/llama-3-8b-base-beta-dpo-hh-helpful.yaml"
    RUN_PREFIX="llama-3-8b-base-beta-dpo-hh-helpful-8xh200"
    DEFAULT_REPO_ID="W-61/llama-3-8b-base-beta-dpo-hh-helpful-8xh200"
    VARIANT_MODEL_ENV="${HH_HELPFUL_SFT_DIR:-}"
    DEFAULT_MODEL_GLOB="$SCRATCH_ROOT/outputs/llama-3-8b-base-sft-hh-helpful-8xh200-*"
    ;;
  hh-harmless)
    CONFIG_PATH="training_configs/llama3-8b-base/beta-dpo/llama-3-8b-base-beta-dpo-hh-harmless.yaml"
    RUN_PREFIX="llama-3-8b-base-beta-dpo-hh-harmless-8xh200"
    DEFAULT_REPO_ID="W-61/llama-3-8b-base-beta-dpo-hh-harmless-8xh200"
