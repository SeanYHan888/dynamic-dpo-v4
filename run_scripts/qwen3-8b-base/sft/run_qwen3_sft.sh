...
usage() {
  cat <<'EOF'
Usage: run_script/sft/run_qwen3_sft.sh <ultrachat|hh-helpful|hh-harmless> [extra run_sft args...]

Environment overrides:
  SCRATCH_ROOT                       Default: /scratch/$USER/dynamic-dpo-v4
  BASE_MODEL_ID                      Default: Qwen/Qwen3-8B-Base
  BASE_MODEL_DIR                     Default: $SCRATCH_ROOT/base_models/Qwen3-8B-Base
...
BASE_MODEL_ID="${BASE_MODEL_ID:-Qwen/Qwen3-8B-Base}"
SCRATCH_ROOT="${SCRATCH_ROOT:-/scratch/${USER}/dynamic-dpo-v4}"
BASE_MODEL_DIR="${BASE_MODEL_DIR:-$SCRATCH_ROOT/base_models/Qwen3-8B-Base}"
...
case "$VARIANT" in
  ultrachat)
    CONFIG_PATH="training_configs/qwen3-8b-base/sft/qwen3-8b-base-sft-ultrachat.yaml"
    RUN_PREFIX="qwen3-8b-base-sft-ultrachat-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-sft-ultrachat-4xh100"
    ;;
  hh-helpful)
    CONFIG_PATH="training_configs/qwen3-8b-base/sft/qwen3-8b-base-sft-hh-helpful.yaml"
    RUN_PREFIX="qwen3-8b-base-sft-hh-helpful-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-sft-hh-helpful-4xh100"
    ;;
  hh-harmless)
    CONFIG_PATH="training_configs/qwen3-8b-base/sft/qwen3-8b-base-sft-hh-harmless.yaml"
    RUN_PREFIX="qwen3-8b-base-sft-hh-harmless-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-sft-hh-harmless-4xh100"
    ;;
  *)
