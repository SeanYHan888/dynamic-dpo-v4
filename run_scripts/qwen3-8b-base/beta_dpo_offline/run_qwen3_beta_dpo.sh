...
usage() {
  cat <<'EOF'
Usage: run_script/beta_dpo_offline/run_qwen3_beta_dpo.sh <ultrafeedback|hh-helpful|hh-harmless> [extra run_beta_dpo args...]
...
case "$VARIANT" in
  ultrafeedback)
    CONFIG_PATH="training_configs/qwen3-8b-base/beta-dpo/qwen3-8b-base-beta-dpo-ultrafeedback.yaml"
    RUN_PREFIX="qwen3-8b-base-beta-dpo-ultrafeedback-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-beta-dpo-ultrafeedback-4xh100"
    DEFAULT_SOURCE_MODEL_ID="qwen3-8b-base-sft-ultrachat-4xh100"
    VARIANT_MODEL_ENV="${ULTRAFEEDBACK_SFT_DIR:-}"
    DEFAULT_MODEL_GLOB="$SCRATCH_ROOT/outputs/qwen3-8b-base-sft-ultrachat-4xh100-*"
    ;;
  hh-helpful)
    CONFIG_PATH="training_configs/qwen3-8b-base/beta-dpo/qwen3-8b-base-beta-dpo-hh-helpful.yaml"
    RUN_PREFIX="qwen3-8b-base-beta-dpo-hh-helpful-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-beta-dpo-hh-helpful-4xh100"
    DEFAULT_SOURCE_MODEL_ID="qwen3-8b-base-sft-hh-helpful-4xh100"
    VARIANT_MODEL_ENV="${HH_HELPFUL_SFT_DIR:-}"
    DEFAULT_MODEL_GLOB="$SCRATCH_ROOT/outputs/qwen3-8b-base-sft-hh-helpful-4xh100-*"
    ;;
  hh-harmless)
    CONFIG_PATH="training_configs/qwen3-8b-base/beta-dpo/qwen3-8b-base-beta-dpo-hh-harmless.yaml"
    RUN_PREFIX="qwen3-8b-base-beta-dpo-hh-harmless-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-beta-dpo-hh-harmless-4xh100"
    DEFAULT_SOURCE_MODEL_ID="qwen3-8b-base-sft-hh-harmless-4xh100"
    VARIANT_MODEL_ENV="${HH_HARMLESS_SFT_DIR:-}"
    DEFAULT_MODEL_GLOB="$SCRATCH_ROOT/outputs/qwen3-8b-base-sft-hh-harmless-4xh100-*"
    ;;
  *)
    echo "Unknown Beta-DPO variant: $VARIANT" >&2
    usage
    exit 1
    ;;
esac
...
echo "Starting offline $VARIANT Beta-DPO run: $RUN"
