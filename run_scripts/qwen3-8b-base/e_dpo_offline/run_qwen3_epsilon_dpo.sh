...
usage() {
  cat <<'EOF'
Usage: run_script/e_dpo_offline/run_qwen3_epsilon_dpo.sh <ultrafeedback|hh-helpful|hh-harmless> [extra run_epsilon_dpo args...]
...
case "$VARIANT" in
  ultrafeedback)
    CONFIG_PATH="training_configs/qwen3-8b-base/e-dpo/qwen3-8b-base-epsilon-dpo-ultrafeedback.yaml"
    RUN_PREFIX="qwen3-8b-base-epsilon-dpo-ultrafeedback-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-epsilon-dpo-ultrafeedback-4xh100"
    ...
    ;;
  hh-helpful)
    CONFIG_PATH="training_configs/qwen3-8b-base/e-dpo/qwen3-8b-base-epsilon-dpo-hh-helpful.yaml"
    RUN_PREFIX="qwen3-8b-base-epsilon-dpo-hh-helpful-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-epsilon-dpo-hh-helpful-4xh100"
    ...
    ;;
  hh-harmless)
    CONFIG_PATH="training_configs/qwen3-8b-base/e-dpo/qwen3-8b-base-epsilon-dpo-hh-harmless.yaml"
    RUN_PREFIX="qwen3-8b-base-epsilon-dpo-hh-harmless-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-epsilon-dpo-hh-harmless-4xh100"
...
echo "Starting offline $VARIANT Epsilon-DPO run: $RUN"
