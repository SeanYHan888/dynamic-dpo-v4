...
usage() {
  cat <<'EOF'
Usage: run_script/dpo_offline/run_qwen3_margin_dpo.sh <ultrafeedback|hh-helpful|hh-harmless> [extra run_margin_dpo args...]
...
case "$VARIANT" in
  ultrafeedback)
    CONFIG_PATH="training_configs/qwen3-8b-base/dpo/qwen3-8b-base-margin-dpo-ultrafeedback.yaml"
    RUN_PREFIX="qwen3-8b-base-margin-dpo-ultrafeedback-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-margin-dpo-ultrafeedback-4xh100"
    ...
    ;;
  hh-helpful)
    CONFIG_PATH="training_configs/qwen3-8b-base/dpo/qwen3-8b-base-margin-dpo-hh-helpful.yaml"
    RUN_PREFIX="qwen3-8b-base-margin-dpo-hh-helpful-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-margin-dpo-hh-helpful-4xh100"
    ...
    ;;
  hh-harmless)
    CONFIG_PATH="training_configs/qwen3-8b-base/dpo/qwen3-8b-base-margin-dpo-hh-harmless.yaml"
    RUN_PREFIX="qwen3-8b-base-margin-dpo-hh-harmless-4xh100"
    DEFAULT_REPO_ID="qwen3-8b-base-margin-dpo-hh-harmless-4xh100"
